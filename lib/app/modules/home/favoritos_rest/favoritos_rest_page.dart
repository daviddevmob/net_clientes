                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      var n = rest.restGeral.restAvaliacaos.map((e) => e.nota);
                      double nota = rest.restGeral.restAvaliacaos.isEmpty 
                      ? 5.0
                      : (n.fold(0, (previousValue, element) => previousValue + element))/rest.restGeral.restAvaliacaos.length;
