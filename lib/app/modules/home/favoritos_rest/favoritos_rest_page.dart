...
class _FavoritosRestPageState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Observer(
        builder: (_) {
          if (controller.list.clienteFavoritoRest == null) {
            return Center(
          ...
          if (controller.list.clienteFavoritoRest.isEmpty) {
            return Center(
              child: TextWidget(
          ...
          if (controller.list.clienteFavoritoRest.isNotEmpty) {
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    ListView.separated(
                      itemCount: controller.list.clienteFavoritoRest.length,
                      shrinkWrap: true,
                      ...
                      itemBuilder: (context, index) {
                        var rest = controller.list.clienteFavoritoRest[index];
